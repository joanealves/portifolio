...
const Works = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      <p style={styles.subtitle}>I had the pleasure of working with these awesome projects</p>
      <Slider {...settings}>
        {works.map((work) => (
...
const styles = {
  ...
  backgroundImage: {
    ...
    height: '534px',
    margin: '0 auto',
    backgroundImage: 'url(https://www.freecodecamp.org/news/content/images/size/w2000/2022/03/photo-1619410283995-43d9134e7656.jpeg)',
